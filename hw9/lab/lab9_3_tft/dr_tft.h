...
void etft_DisplayChineseChar(uint16_t sx, uint16_t sy, const unsigned char *bitmap, uint16_t fRGB, uint16_t bRGB);
void etft_DisplayChineseString(uint16_t sx, uint16_t sy, int start_index, int count, uint16_t fRGB, uint16_t bRGB);

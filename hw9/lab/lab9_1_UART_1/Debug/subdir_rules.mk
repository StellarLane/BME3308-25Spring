...
dr_tft.obj: ../dr_tft.c $(GEN_OPTS) $(GEN_SRCS)
	...
	"F:/Softwares/ccsv5/tools/compiler/msp430_4.1.2/bin/cl430" -vmspx --abi=coffabi -g --include_path="F:/Softwares/ccsv5/ccs_base/msp430/include" --include_path="F:/Softwares/ccsv5/tools/compiler/msp430_4.1.2/include" --define=__MSP430F6638__ --diag_warning=225 --display_error_number --silicon_errata=CPU21 --silicon_errata=CPU22 --silicon_errata=CPU40 --printf_support=minimal --preproc_with_compile --preproc_dependency="dr_tft.pp" $(GEN_OPTS__FLAG) "$<"
